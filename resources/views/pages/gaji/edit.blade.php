...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Edit Gaji Karyawan</h1>
    </div>
    <div class="col-sm-6">
        ...
        <form action="{{ route('gaji.update', $gajiKaryawan->id) }}" method="POST">
            ...
            <div class="card card-primary card-outline">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="jumlah_gaji" id="jumlah_gaji" class="form-control @error('jumlah_gaji') is-invalid @enderror" value="{{ old('jumlah_gaji', $gajiKaryawan->jumlah_gaji) }}" min="0" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="bonus_persen" id="bonus_persen" class="form-control @error('bonus_persen') is-invalid @enderror" value="{{ old('bonus_persen', $gajiKaryawan->bonus_persen) }}" min="0" max="100" step="0.01" placeholder="Contoh: 10 untuk 10%">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="jumlah_bonus" id="jumlah_bonus" value="{{ old('jumlah_bonus', $gajiKaryawan->jumlah_bonus) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="sisa_gaji" id="sisa_gaji" value="{{ old('sisa_gaji', $gajiKaryawan->sisa_gaji) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_pembayaran" id="status_pembayaran" class="form-control @error('status_pembayaran') is-invalid @enderror" required>
                                    <option value="belum_lunas" {{ old('status_pembayaran', $gajiKaryawan->status_pembayaran) == 'belum_lunas' ? 'selected' : '' }}>Belum Lunas</option>
                                    <option value="dibayar_sebagian" {{ old('status_pembayaran', $gajiKaryawan->status_pembayaran) == 'dibayar_sebagian' ? 'selected' : '' }}>Dibayar Sebagian</option>
                ...
                <div class="card-footer text-right">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i> Update Gaji</button>
                </div>
            </div>
        </form>
    </div>
