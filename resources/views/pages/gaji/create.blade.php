...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0">Tambah Gaji Karyawan</h1>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Form Tambah Gaji Karyawan</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('gaji.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_gaji" id="jumlah_gaji" class="form-control @error('jumlah_gaji') is-invalid @enderror" value="{{ old('jumlah_gaji', 0) }}" min="0" step="0.01" required>
                        @error('jumlah_gaji')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="bonus_persen" id="bonus_persen" class="form-control @error('bonus_persen') is-invalid @enderror" value="{{ old('bonus_persen', 0) }}" min="0" max="100" step="0.01">
                        @error('bonus_persen')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jumlah_bonus" id="jumlah_bonus" class="form-control" value="{{ old('jumlah_bonus', 0) }}" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_pembayaran" id="status_pembayaran" class="form-control @error('status_pembayaran') is-invalid @enderror" required>
                            ...
                            <option value="bayar sebagian" {{ old('status_pembayaran') == 'bayar sebagian' ? 'selected' : '' }}>Bayar Sebagian</option>
                            <option value="bayar setengah" {{ old('status_pembayaran') == 'bayar setengah' ? 'selected' : '' }}>Bayar Setengah</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sisa_gaji" id="sisa_gaji" class="form-control" value="{{ old('sisa_gaji', 0) }}" readonly>
                    </div>
