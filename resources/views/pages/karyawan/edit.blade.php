...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-user-edit mr-2"></i>Edit Data Karyawan</h1>
    </div>
    <div class="col-sm-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label for="foto" class="image-upload-container">
                                    <img id="foto-preview" 
                                         src="{{ $karyawan->foto ? asset('storage/' . $karyawan->foto) : 'https://placehold.co/300x400/cccccc/333333?text=Pilih+Foto' }}" 
                                         alt="Foto Karyawan" 
                                         class="image-preview">
                                    <span class="text-primary">Klik untuk mengubah foto</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="id_karyawan" class="form-control" value="{{ $karyawan->id_karyawan }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
