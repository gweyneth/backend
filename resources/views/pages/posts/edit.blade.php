...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-edit mr-2"></i>Edit Post</h1>
    </div>
    <div class="col-sm-6">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" rows="15">{{ old('content', $post->content) }}</textarea>
        ...
        <div class="col-md-4">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <label for="image" class="image-upload-container">
                            <img id="image-preview" src="{{ $post->image ? asset('storage/' . $post->image) : 'https://placehold.co/600x400/e9ecef/6c757d?text=Pilih+Gambar' }}" alt="Pratinjau Gambar" class="image-preview">
                            <span class="text-primary mt-2">Klik untuk mengubah gambar</span>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-save mr-1"></i> Update Postingan</button>
