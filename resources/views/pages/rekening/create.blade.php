...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0">Tambah Rekening Baru</h1>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Form Tambah Rekening</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('rekening.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="atas_nama" id="atas_nama" class="form-control @error('atas_nama') is-invalid @enderror" value="{{ old('atas_nama') }}" required>
                        @error('atas_nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_bank" id="kode_bank" class="form-control @error('kode_bank') is-invalid @enderror" value="{{ old('kode_bank') }}">
                        @error('kode_bank')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
